...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="css/auth.css" media="screen" />
...
<body class="align">
  <?php if($errors->any()): ?>
  <h4 class="shake" style="color: red"><?php echo e($errors->first()); ?></h4>
  <?php endif; ?>
    ...
    <div class="grid">
      ...
      <form action="login" method="POST" class="form login">
        ...
        <!-- add the csrf_token inside query -->
